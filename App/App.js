  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.cardtxtq}>How to use the product the all rounder way?</Text>
            ...
            <Text style={styles.cardtxtq} onPress = {() => Linking.openURL('https://github.com/HAESolve/CAD-HAESolve'}}>product source code page(link)</Text> then download model.h5 then download a file and save it in your device and ...  
